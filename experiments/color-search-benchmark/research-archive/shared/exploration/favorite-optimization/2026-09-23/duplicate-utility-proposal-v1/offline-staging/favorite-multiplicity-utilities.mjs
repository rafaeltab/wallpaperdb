// PROPOSAL ONLY: query-only correction for duplicate resolved utility targets.
// No indexing changes, no document filtering/ranking in the application.
import { FAVORITE_DOCVALUE_FETCH_METHODS, buildFavoriteDocvalueQuery, decodeFavoriteDocvalueFetchResponse, supportsFavoriteDocvalueFetch } from 'file:///home/rafaeltab/.t3/worktrees/wallpaperdb/t3code-28be15f7/experiments/color-search-benchmark/exploration/favorite-docvalue-fetch.mjs';
import { FAVORITE_BOUNDED_METHODS, buildFavoriteBoundedQuery, executeFavoriteBoundedUtilitySearch, supportsFavoriteBounded } from 'file:///home/rafaeltab/.t3/worktrees/wallpaperdb/t3code-28be15f7/experiments/color-search-benchmark/exploration/favorite-bounded-utilities.mjs';
import { api, safeIndexName } from 'file:///home/rafaeltab/.t3/worktrees/wallpaperdb/t3code-28be15f7/experiments/color-search-benchmark/exploration/service.mjs';
...
const methodFor = (input = FAVORITE_MULTIPLICITY_METHODS[0].id) => {
  ...
  if (!method) throw Error('Unknown multiplicity proposal method: ' + id);
  return method;
};
