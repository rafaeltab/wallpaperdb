# Color evaluation: 2026-09-20T03-06-53.036Z-cafdbda3
...
```json
{
  "id": "2026-09-20T03-06-53.036Z-cafdbda3",
  "createdAt": "2026-09-20T03:06:53.042Z",
  "dataset": {
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Native indexed picked-color grid | opensearch | 30 | 1.97 ms | 2.92 ms | 3.19 ms | 0 | 43.24 ms |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Native indexed picked-color grid | 58.86 ms | 84.95 MiB | 91.70 MiB | 17.77 MiB | n/a | n/a | n/a |
...
| precision-shade-001 | Color picker: #FF2200 | ok | 80.0% | 80.0% | 5/5 | — | 0 | 80.0% | 100.0% | 3.19 ms |
...
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 83.3% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 2.78 ms |
...
```json
{
  ...
  "sourceHashes": {
    "exploration/adapter.mjs": "78b32b0f531c47980f21872f739c98c594e0dbcff44a18fececf33f5be28e1cd",
  ...
  "setup": {
    ...
    "elapsedMs": 43.24217399999999
  },
  "resources": {
    "serviceCpuMs": 58.864,
    "measurementBlockMs": 72.21222800000001,
    "memoryBefore": {
      "rss": 89071616,
      "heapTotal": 20291584,
      "heapUsed": 13935968,
  ...
  "summary": {
    ...
    "performance": {
      ...
      "sampleCount": 30,
      "p50Ms": 1.9724410000000034,
      "p95Ms": 2.918089999999978,
      "maxMs": 3.1945499999999925,
      "failures": 0
    }
  }
}
...
```json
{
  ...
  "performance": {
    ...
    "sampleCount": 10,
    "p50Ms": 2.04513799999998,
    "p95Ms": 3.1945499999999925,
    "maxMs": 3.1945499999999925,
    "failures": 0,
    "trials": [
      {
        "round": 0,
        "elapsedMs": 3.1945499999999925,
        "hits": [
          {
            "id": "precision-shade-001-b",
            "score": 0.8344189
...
```json
{
  ...
  "performance": {
    ...
    "p50Ms": 1.9724410000000034,
    "p95Ms": 2.918089999999978,
    "maxMs": 2.918089999999978,
    "failures": 0,
    "trials": [
      {
        "round": 0,
        "elapsedMs": 2.8266179999999963,
        "hits": [
          {
            "id": "precision-shade-001-b",
            "score": 0.8344189
...
```json
{
  ...
  "performance": {
    ...
    "sampleCount": 10,
    "p50Ms": 1.9430560000000128,
    "p95Ms": 2.782796000000019,
    "maxMs": 2.782796000000019,
    "failures": 0,
    "trials": [
      {
        "round": 0,
        "elapsedMs": 2.580204000000009,
        "hits": [
          {
            "id": "composition-green-red-001-d",
            "score": 0.7555116
