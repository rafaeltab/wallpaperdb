...
- Wallpaper and contributor Profile reads, Profile discovery and canonical Handle routing, color ranking, rendition filters and pagination
...
Manages user identities, profiles, and Clerk webhook processing.

**Key Features:**
- Clerk webhook processing for user lifecycle events
...
**Event-driven:**
- Consumes: Clerk webhooks (HTTP)
- Publishes: user events (NATS)

[View Full Documentation →](/docs/services/user)

### Tagging Service
**Status:** 🚧 In Development

Minimal service shell for future tagging work.

**Current Scope:**
- Tag service scaffold with PostgreSQL and NATS wiring
- Health and readiness endpoints only

**API-driven:**
- Operational endpoints only for now

[View Full Documentation →](/docs/services/tags)
...
| Service | Port | Database | S3/SeaweedFS | NATS | Redis | Status |
|---------|------|----------|----------|------|-------|--------|
| Ingestor | 3001 | ✓ | ✓ | ✓ (publish) | ✓ | ✅ Complete |
| Media | 3002 | ✓ | ✓ | ✓ (consume) | - | ✅ Complete |
| Variant Gen | 3004 | - | ✓ | ✓ (pub/sub) | - | ✅ Complete |
| Gateway | 3000 | ✓ | - | ✓ (consume) | ✓ | ✅ Complete |
| Web | 3005 | - | - | - | - | ✅ Complete |
| Thumbnail | 3003 | ✓ | ✓ | ✓ | - | 📋 Planned |
| Quality | 3006 | ✓ | ✓ | ✓ | - | 📋 Planned |
| Color | 3007 | ✓ | ✓ | ✓ | - | 📋 Planned |
| User | 3009 | ✓ | - | ✓ (publish) | - | 🚧 In Development |
| Tagging | 3008 | ✓ | - | ✓ | - | 🚧 In Development |
...
- **AWS SDK v3** - S3/SeaweedFS client
...
- ✅ Variant Generator (production-ready)
...
1. User Service (Clerk webhooks, profile management)
