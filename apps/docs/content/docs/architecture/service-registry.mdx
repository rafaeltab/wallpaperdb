...
|---------|------|--------|----------|--------------|------------------|-----------------|
| **Ingestor** | 3001 | ✅ Production | wallpaperdb_ingestor | PostgreSQL, MinIO, NATS, Redis | `wallpaper.uploaded` | - |
| **Media** | 3002 | ✅ Production | wallpaperdb_media | PostgreSQL, MinIO, Redis | `wallpaper.variant.available` | `wallpaper.uploaded`, `wallpaper.variant.uploaded` |
| **Variant Generator** | 3004 | ✅ Production | - | MinIO, NATS | `wallpaper.variant.uploaded` | `wallpaper.uploaded` |
...
| **Thumbnail Extractor** | 3003 | 📋 Planned | - | MinIO, NATS, FFmpeg | `thumbnail.generated` | `wallpaper.uploaded` |
| **Quality Enrichment** | 3006 | 📋 Planned | wallpaperdb_quality | PostgreSQL, MinIO, NATS | `quality.analyzed` | `wallpaper.uploaded` |
| **Color Enrichment** | 3007 | 📋 Planned | wallpaperdb_colors | PostgreSQL, MinIO, NATS | `colors.extracted` | `wallpaper.uploaded` |
