# Color evaluation: 2026-09-20T02-45-21.426Z-c8b05700
...
```json
{
  "id": "2026-09-20T02-45-21.426Z-c8b05700",
  "createdAt": "2026-09-20T02:45:21.431Z",
  "dataset": {
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ClickHouse exact picked-color palette precision | clickhouse | 30 | 8.71 ms | 25.28 ms | 26.07 ms | 0 | 30.42 ms |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ClickHouse exact picked-color palette precision | 58.14 ms | 74.70 MiB | 79.70 MiB | 13.69 MiB | n/a | n/a | 0.43 MiB |
...
| precision-shade-001 | Color picker: #FF2200 | ok | 80.0% | 80.0% | 5/5 | — | 0 | 80.0% | 100.0% | 26.07 ms |
...
| precision-warm-red-batch-001 | Close to #FF2200 | ok | 91.7% | 91.7% | 6/6 | — | 0 | n/a | 0.0% | 9.30 ms |
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 66.7% | 80.0% | 6/6 | — | 0 | n/a | 0.0% | 25.28 ms |
...
```json
{
  ...
  "sourceHashes": {
    ...
    "exploration/methods-clickhouse.mjs": "090afac879b9af57c0a80240ee6dcf8535b4b3f27b87d0a99e8927d729a41355",
    "exploration/clickhouse-index.mjs": "89e434e4339b97da3e2793fc92936f42980f74b5f0e007b7a575235a8786368e",
    "exploration/clickhouse-scale.mjs": "2c9268375789cf32dd568a0ff2603b1d01fdde7348085928c1497793d7d8d272",
  ...
  "setup": {
    ...
    "metrics": {
      "CGroupMaxCPU": 8,
      "OSSystemTime": 0.13973520179260301,
      "CGroupMemoryUsed": 459369456,
      "MemoryResident": 969605120,
      "OSUserTime": 8.463960794294811
    },
    "containerLimits": {
      "cpus": 8,
      "memoryBytes": 12884901888,
    ...
    "elapsedMs": 30.419270999999995
  },
  "resources": {
    "serviceCpuMs": 58.138,
    "measurementBlockMs": 347.23436300000003,
    "memoryBefore": {
      "rss": 78323712,
      "heapTotal": 21340160,
      "heapUsed": 15181088,
  ...
  "summary": {
    ...
    "performance": {
      ...
      "sampleCount": 30,
      "p50Ms": 8.709394000000032,
      "p95Ms": 25.279487000000017,
      "maxMs": 26.06598599999998,
      "failures": 0
    }
  }
}
...
```json
{
  ...
  "searchEvidence": {
    "evidence": {
      "engine": "clickhouse",
      "table": "color_exploration_real_v1",
      "httpMs": 10.14352000000001,
      "serviceTookMs": 8.046177,
      "rowsRead": 545,
      "bytesRead": 555675,
      "queryId": "color-exploration-194f63f1-9f09-492c-a23e-97d1a5fef811",
      "summary": {
        "read_rows": "545",
        "read_bytes": "555675",
        "written_rows": "0",
  ...
  "performance": {
    ...
    "sampleCount": 10,
    "p50Ms": 8.75207499999999,
    "p95Ms": 26.06598599999998,
    "maxMs": 26.06598599999998,
    "failures": 0,
    "trials": [
      {
        "round": 0,
        "elapsedMs": 8.908438000000018,
        "hits": [
          {
            "id": "precision-shade-001-d",
            "score": 0.99955964
...
```json
{
  ...
  "searchEvidence": {
    "evidence": {
      "engine": "clickhouse",
      "table": "color_exploration_real_v1",
      "httpMs": 9.44214199999999,
      "serviceTookMs": 7.453864,
      "rowsRead": 545,
      "bytesRead": 555675,
      "queryId": "color-exploration-e6057c44-2539-46e9-8ca9-3cda9e5f6f25",
      "summary": {
        "read_rows": "545",
        "read_bytes": "555675",
        "written_rows": "0",
  ...
  "performance": {
    ...
    "sampleCount": 10,
    "p50Ms": 8.499459000000002,
    "p95Ms": 9.296588000000042,
    "maxMs": 9.296588000000042,
    "failures": 0,
    "trials": [
      {
        "round": 0,
        "elapsedMs": 8.961998999999992,
        "hits": [
          {
            "id": "precision-shade-001-d",
            "score": 0.99955964
...
```json
{
  ...
  "searchEvidence": {
    "evidence": {
      "engine": "clickhouse",
      "table": "color_exploration_real_v1",
      "httpMs": 19.968211999999994,
      "serviceTookMs": 14.105991,
      "rowsRead": 545,
      "bytesRead": 555675,
      "queryId": "color-exploration-d9a2d308-a6ce-48b8-82c7-b3f6d6d44739",
      "summary": {
        "read_rows": "545",
        "read_bytes": "555675",
        "written_rows": "0",
  ...
  "performance": {
    ...
    "sampleCount": 10,
    "p50Ms": 8.799914999999999,
    "p95Ms": 25.279487000000017,
    "maxMs": 25.279487000000017,
    "failures": 0,
    "trials": [
      {
        "round": 0,
        "elapsedMs": 9.298901999999998,
        "hits": [
          {
            "id": "composition-green-red-001-d",
            "score": 0.8284006
