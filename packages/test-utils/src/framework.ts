...
type InferRequiredTesters<TTester extends AnyTester> =
    TTester extends BaseTesterBuilder<
        string,
        infer Required extends TupleOfTesters
    >
    ? Required
    : never;
type InferAddMethodReturnType<TTester extends AnyTester> = ReturnTypeOf<
    InferAddMethod<TTester>
>;
...
class TesterBuilder<TTesters extends TupleOfTesters = []> {
    ...
    >(
        testerConstructor: RequireTesters<
            TTesterConstructor,
            TRequiredTesters,
            TTesters
        >,
...
export type AddMethodsType<TRequiredTesters extends TupleOfTesters> =
    ...
    ? any
    : TupleToIntersectionOfConstructors<
        [...InferAddMethodClasses<TRequiredTesters>, Tester]
    >;
