...
Use [Coding Standards — Architecture](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#architecture), [Ports and transactions](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#ports-and-transactions), and [Application programming model](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#application-programming-model) to design the service's capabilities and their public interfaces.
...
These snippets illustrate current package APIs. [Coding Standards — Cross-application interactions and contracts](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#cross-application-interactions-and-contracts) and [Delivery reliability](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#delivery-reliability) define the event contracts and guarantees required of an application using them.
