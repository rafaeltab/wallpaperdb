...
const products: Product[] = [
  ...
  { id: 9, name: 'Desk Lamp', price: 59, rating: 4.4, date: '2024-02-05' },
  { id: 10, name: 'Cable Organizer', price: 15, rating: 4.1, date: '2024-03-01' },
  { id: 11, name: 'Wireless Charger', price: 35, rating: 4.6, date: '2024-01-25' },
  { id: 12, name: 'Laptop Stand', price: 89, rating: 4.7, date: '2024-02-15' },
  { id: 13, name: 'Microphone', price: 129, rating: 4.5, date: '2024-03-10' },
  { id: 14, name: 'Graphics Tablet', price: 249, rating: 4.3, date: '2024-01-10' },
  { id: 15, name: 'External SSD', price: 119, rating: 4.8, date: '2024-04-05' },
  { id: 16, name: 'Docking Station', price: 179, rating: 4.4, date: '2024-02-20' },
  { id: 17, name: 'Desk Mat', price: 25, rating: 4.2, date: '2024-03-25' },
  { id: 18, name: 'Wrist Rest', price: 22, rating: 4.0, date: '2024-01-30' },
  { id: 19, name: 'Monitor Arm', price: 99, rating: 4.6, date: '2024-02-08' },
  { id: 20, name: 'Speakers', price: 69, rating: 4.5, date: '2024-04-10' },
  { id: 21, name: 'Ergonomic Chair', price: 449, rating: 4.7, date: '2024-01-08' },
  { id: 22, name: 'Standing Desk', price: 599, rating: 4.4, date: '2024-03-05' },
  { id: 23, name: 'Footrest', price: 45, rating: 4.1, date: '2024-02-12' },
  { id: 24, name: 'Air Purifier', price: 159, rating: 4.3, date: '2024-04-15' },
  { id: 25, name: 'Desk Fan', price: 39, rating: 4.2, date: '2024-01-18' },
  { id: 26, name: 'Cable Clips', price: 12, rating: 4.0, date: '2024-03-18' },
  { id: 27, name: 'Headphone Stand', price: 29, rating: 4.5, date: '2024-02-25' },
  { id: 28, name: 'USB Microphone', price: 89, rating: 4.6, date: '2024-04-02' },
  { id: 29, name: 'Ring Light', price: 55, rating: 4.4, date: '2024-01-22' },
  { id: 30, name: 'Privacy Screen', price: 49, rating: 4.1, date: '2024-03-12' },
  { id: 31, name: 'Keyboard Tray', price: 65, rating: 4.3, date: '2024-02-18' },
  { id: 32, name: 'Monitor Light', price: 45, rating: 4.7, date: '2024-04-08' },
  { id: 33, name: 'Desk Organizer', price: 35, rating: 4.2, date: '2024-01-28' },
  { id: 34, name: 'Whiteboard', price: 75, rating: 4.4, date: '2024-03-22' },
  { id: 35, name: 'Pen Holder', price: 18, rating: 4.0, date: '2024-02-02' },
  { id: 36, name: 'Document Holder', price: 28, rating: 4.1, date: '2024-04-12' },
  { id: 37, name: 'Webcam Cover', price: 8, rating: 4.5, date: '2024-01-12' },
  { id: 38, name: 'Surge Protector', price: 42, rating: 4.6, date: '2024-03-28' },
  { id: 39, name: 'USB-C Hub', price: 59, rating: 4.8, date: '2024-02-22' },
  { id: 40, name: 'Desk Clock', price: 32, rating: 4.3, date: '2024-04-18' },
];
