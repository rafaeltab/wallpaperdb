...
describe('StorageService', () => {
  it('should upload file to SeaweedFS and return storage key', async () => {
    const service = new StorageService(mockS3Client);
...
2. **Integration Tests** - Test service integration with infrastructure
   ...
   - Test database operations, SeaweedFS uploads, NATS publishing
