# Color evaluation: 2026-09-23T15-32-41.534Z-1d889ffc
...
```json
{
  "id": "2026-09-23T15-32-41.534Z-1d889ffc",
  "createdAt": "2026-09-23T15:32:41.539Z",
  "dataset": {
...
| Favorite256: native numeric sort | No approximation statement supplied | Preserves the favorite256 shade-aware strict-hue measurements, anchors and independently weighted five-cutoff formula at offered presets. Quality influence is restricted to 0, 0.5 or 1; cutoff weighting to 0, 1 or 3; target proportions to multiples of 5%. Other scoring controls retain the saved defaults. Moving per-target sums before query-time averaging changes float32 rounding order. Formula preservation does not mean bitwise score or near-tie order identity. Abstract vibes and named families retain the original single named-feature definition. Overlap is marginal; there is no new palette-purity or accent objective. Every eligible document participates in the OpenSearch ranking, including zero-score documents. There is no candidate retrieval or application reranking. Float32 target utilities and scores; same mathematical formula at supported presets, with changed floating-point grouping. Requires a separate index with index:true and doc\_values:true for every float utility; the existing doc-values-only mapping is not this experiment. Numeric sorting applies only to a single requested target. Multi-target queries use the unchanged numeric utility score query and gain no numeric-sort optimization. Single-target \_score is not calculated. The adapter copies the first OpenSearch sort value into the result score without filtering, sorting, or reranking any returned hits. Point-based skipping is an engine optimization to measure, not a guaranteed speedup. Filtering, ties and segment layouts affect its benefit. Development judgments are from one observer; new ZIP wallpapers are unjudged. |
| Favorite256: native numeric sort with score tracking | No approximation statement supplied | Preserves the favorite256 shade-aware strict-hue measurements, anchors and independently weighted five-cutoff formula at offered presets. Quality influence is restricted to 0, 0.5 or 1; cutoff weighting to 0, 1 or 3; target proportions to multiples of 5%. Other scoring controls retain the saved defaults. Moving per-target sums before query-time averaging changes float32 rounding order. Formula preservation does not mean bitwise score or near-tie order identity. Abstract vibes and named families retain the original single named-feature definition. Overlap is marginal; there is no new palette-purity or accent objective. Every eligible document participates in the OpenSearch ranking, including zero-score documents. There is no candidate retrieval or application reranking. Float32 target utilities and scores; same mathematical formula at supported presets, with changed floating-point grouping. Requires a separate index with index:true and doc\_values:true for every float utility; the existing doc-values-only mapping is not this experiment. Numeric sorting applies only to a single requested target. Multi-target queries use the unchanged numeric utility score query and gain no numeric-sort optimization. OpenSearch 2.11 combines score tracking with a MaxScoreCollector using COMPLETE score mode. That prevents relying on numeric competitive-iterator skipping; this is the control, not the expected fast path. Point-based skipping is an engine optimization to measure, not a guaranteed speedup. Filtering, ties and segment layouts affect its benefit. Development judgments are from one observer; new ZIP wallpapers are unjudged. |
...
| Favorite256: native numeric sort | opensearch | 32/38 | 6 | 0 | 69.5% | 68.9% | 88.3% | 86.7% | 0 |
| Favorite256: native numeric sort with score tracking | opensearch | 32/38 | 6 | 0 | 69.5% | 68.9% | 88.3% | 86.7% | 0 |
...
| Favorite256: native numeric sort | 13/38 | 48.7% | 51.4% | 19.2% | 34.2% | 0 |
| Favorite256: native numeric sort with score tracking | 13/38 | 48.7% | 51.4% | 19.2% | 34.2% | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| All cutoffs: shade-aware + strict hue (256 buckets, all cutoffs, blend 1, concrete-swatches) | opensearch | 96 | 3.25 ms | 4.46 ms | 5.82 ms | 0 | 3210.09 ms |
| Favorite256: precomputed float utility | opensearch | 96 | 3.03 ms | 4.11 ms | 5.74 ms | 0 | 339.45 ms |
| Favorite256: native numeric sort | opensearch | 96 | 2.65 ms | 3.75 ms | 5.45 ms | 0 | 399.17 ms |
| Favorite256: native numeric sort with score tracking | opensearch | 96 | 2.93 ms | 3.78 ms | 5.20 ms | 0 | 231.72 ms |
| Favorite256: globally bounded numeric utilities | opensearch | 96 | 3.84 ms | 5.45 ms | 6.51 ms | 0 | 168.21 ms |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| All cutoffs: shade-aware + strict hue (256 buckets, all cutoffs, blend 1, concrete-swatches) | 140.09 ms | 303.44 MiB | 305.94 MiB | 158.01 MiB | n/a | n/a | n/a |
| Favorite256: precomputed float utility | 208.34 ms | 137.36 MiB | 144.11 MiB | 24.81 MiB | n/a | n/a | n/a |
| Favorite256: native numeric sort | 192.99 ms | 156.45 MiB | 156.70 MiB | 25.00 MiB | n/a | n/a | n/a |
| Favorite256: native numeric sort with score tracking | 235.20 ms | 142.63 MiB | 151.88 MiB | 27.24 MiB | n/a | n/a | n/a |
| Favorite256: globally bounded numeric utilities | 485.61 ms | 183.50 MiB | 197.00 MiB | 58.10 MiB | n/a | n/a | n/a |
...
| perceived-red-001 | red | ok | 86.7% | 86.7% | 15/15 | — | 0 | n/a | 0.0% | 3.50 ms |
| vibe-grayscale-001 | grayscale | ok | 100.0% | 100.0% | 12/12 | — | 0 | n/a | 0.0% | 2.49 ms |
| vibe-dark-001 | dark | ok | 100.0% | 100.0% | 15/15 | — | 0 | n/a | 0.0% | 2.81 ms |
...
| precision-shade-001 | Color picker: #FF2200 | ok | 20.0% | 20.0% | 5/5 | — | 0 | 20.0% | 100.0% | 4.34 ms |
| semantic-red-city-001 | A city wallpaper with a red feel (Condition: Assuming C matches the city tag.) | ok | 100.0% | 100.0% | 3/3 | — | 0 | 100.0% | 100.0% | 1.43 ms |
| proportion-green-001 | 40% green; the rest doesn’t matter | ok | 86.7% | 86.7% | 15/15 | — | 0 | 100.0% | 20.0% | 3.32 ms |
| proportion-green-002 | 40% green; the rest doesn’t matter | ok | 93.3% | 93.3% | 15/15 | — | 0 | 93.3% | 100.0% | 3.77 ms |
| composition-green-red-001 | 50% green, 50% red | ok | 53.3% | 53.3% | 15/15 | — | 0 | 53.3% | 100.0% | 4.09 ms |
| composition-green-red-real-001 | 50% green, 50% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | 100.0% | 16.7% | 4.00 ms |
| composition-green-red-real-002 | 40% green, 40% red; the remaining 20% is unspecified | ok | 0.0% | 0.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.93 ms |
| perceived-red-batch-001 | Red | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 4.59 ms |
| perceived-orange-batch-001 | Orange | ok | 83.3% | 83.3% | 6/6 | — | 0 | 100.0% | 16.7% | 3.85 ms |
| perceived-pink-batch-001 | Pink | ok | 33.3% | 33.3% | 6/6 | — | 0 | n/a | 0.0% | 3.59 ms |
| perceived-green-batch-001 | Green | ok | 83.3% | 80.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.17 ms |
| perceived-blue-batch-001 | Blue | ok | 83.3% | 80.0% | 6/6 | — | 0 | n/a | 0.0% | 3.61 ms |
| proportion-green-real-batch-001 | 40% green; the remaining 60% is unspecified | ok | 16.7% | 20.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.32 ms |
| proportion-green-real-batch-002 | 70% green; the remaining 30% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | 0.0% | 16.7% | 3.57 ms |
| proportion-red-real-batch-001 | 20% red; the remaining 80% is unspecified | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 4.09 ms |
| vibe-dark-batch-001 | Dark | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 2.96 ms |
| vibe-light-batch-001 | Light | ok | 83.3% | 83.3% | 6/6 | — | 0 | 0.0% | 16.7% | 4.11 ms |
| vibe-vivid-batch-001 | Bright, vivid colors | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 5.82 ms |
| vibe-strict-grayscale-batch-001 | Grayscale | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.32 ms |
| vibe-near-neutral-batch-001 | Almost grayscale | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 2.75 ms |
| vibe-monochromatic-batch-001 | One hue overall | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 2.60 ms |
...
| composition-gray-red-batch-001 | 80% grayscale, 20% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.80 ms |
| composition-gray-red-batch-002 | 80% grayscale, 10% red; the remaining 10% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 4.91 ms |
...
| composition-blue-orange-batch-001 | 50% blue, 50% orange | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 4.92 ms |
| composition-blue-orange-batch-002 | 40% blue, 40% orange; the remaining 20% is unspecified | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 4.15 ms |
| precision-warm-red-batch-001 | Close to #FF2200 | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.15 ms |
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 50.0% | 40.0% | 6/6 | — | 0 | 66.7% | 50.0% | 4.46 ms |
| palette-rainbow-batch-001 | Rainbow-like colors | ok | 66.7% | 60.0% | 6/6 | — | 0 | n/a | 0.0% | 4.16 ms |
| perceived-red-pagoda-001 | red | ok | 100.0% | 100.0% | 1/1 | — | 0 | n/a | 0.0% | 4.36 ms |
...
| composition-001 | 80% grayscale 20% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/1 | composition-001/A, composition-001/B | 0 | n/a | 0.0% | n/a |
| composition-002 | 80% grayscale 10% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/0 | composition-002/A, composition-002/B | 0 | n/a | n/a | n/a |
| perceived-red-001 | red | ok | 86.7% | 86.7% | 15/15 | — | 0 | n/a | 0.0% | 4.11 ms |
| vibe-grayscale-001 | grayscale | ok | 100.0% | 100.0% | 12/12 | — | 0 | n/a | 0.0% | 5.73 ms |
| vibe-dark-001 | dark | ok | 100.0% | 100.0% | 15/15 | — | 0 | n/a | 0.0% | 3.78 ms |
| combination-gray-red-001 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/15 | wallpaper-042, wallpaper-060, wallpaper-037, wallpaper-065, wallpaper-029, wallpaper-048 | 0 | n/a | 0.0% | n/a |
| combination-gray-red-002 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/3 | evaluation-gray-red-002-telephone, wallpaper-048, evaluation-gray-red-002-umbrella | 0 | n/a | 0.0% | n/a |
| precision-shade-001 | Color picker: #FF2200 | ok | 20.0% | 20.0% | 5/5 | — | 0 | 20.0% | 100.0% | 3.76 ms |
| semantic-red-city-001 | A city wallpaper with a red feel (Condition: Assuming C matches the city tag.) | ok | 100.0% | 100.0% | 3/3 | — | 0 | 100.0% | 100.0% | 2.16 ms |
| proportion-green-001 | 40% green; the rest doesn’t matter | ok | 86.7% | 86.7% | 15/15 | — | 0 | 100.0% | 20.0% | 4.16 ms |
| proportion-green-002 | 40% green; the rest doesn’t matter | ok | 93.3% | 93.3% | 15/15 | — | 0 | 93.3% | 100.0% | 3.71 ms |
| composition-green-red-001 | 50% green, 50% red | ok | 53.3% | 53.3% | 15/15 | — | 0 | 53.3% | 100.0% | 4.04 ms |
| composition-green-red-real-001 | 50% green, 50% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | 100.0% | 16.7% | 3.82 ms |
| composition-green-red-real-002 | 40% green, 40% red; the remaining 20% is unspecified | ok | 0.0% | 0.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.96 ms |
| perceived-red-batch-001 | Red | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 5.74 ms |
| perceived-orange-batch-001 | Orange | ok | 83.3% | 83.3% | 6/6 | — | 0 | 100.0% | 16.7% | 3.49 ms |
| perceived-pink-batch-001 | Pink | ok | 33.3% | 33.3% | 6/6 | — | 0 | n/a | 0.0% | 3.89 ms |
| perceived-green-batch-001 | Green | ok | 83.3% | 80.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.48 ms |
| perceived-blue-batch-001 | Blue | ok | 83.3% | 80.0% | 6/6 | — | 0 | n/a | 0.0% | 3.34 ms |
| proportion-green-real-batch-001 | 40% green; the remaining 60% is unspecified | ok | 16.7% | 20.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.08 ms |
| proportion-green-real-batch-002 | 70% green; the remaining 30% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | 0.0% | 16.7% | 3.73 ms |
| proportion-red-real-batch-001 | 20% red; the remaining 80% is unspecified | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 4.61 ms |
| vibe-dark-batch-001 | Dark | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.74 ms |
| vibe-light-batch-001 | Light | ok | 83.3% | 83.3% | 6/6 | — | 0 | 0.0% | 16.7% | 4.01 ms |
| vibe-vivid-batch-001 | Bright, vivid colors | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.65 ms |
| vibe-strict-grayscale-batch-001 | Grayscale | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.65 ms |
| vibe-near-neutral-batch-001 | Almost grayscale | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.76 ms |
| vibe-monochromatic-batch-001 | One hue overall | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.28 ms |
| combination-gray-red-batch-001 | Grayscale with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-095, wallpaper-060, evaluation-gray-red-002-telephone, wallpaper-063 | 0 | n/a | 0.0% | n/a |
| composition-gray-red-batch-001 | 80% grayscale, 20% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.91 ms |
| composition-gray-red-batch-002 | 80% grayscale, 10% red; the remaining 10% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.87 ms |
| vibe-dark-accents-batch-001 | Mostly dark, with small bright areas | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-005, wallpaper-032, wallpaper-022, wallpaper-015 | 0 | n/a | 0.0% | n/a |
| composition-blue-orange-batch-001 | 50% blue, 50% orange | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.91 ms |
| composition-blue-orange-batch-002 | 40% blue, 40% orange; the remaining 20% is unspecified | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 2.99 ms |
| precision-warm-red-batch-001 | Close to #FF2200 | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.11 ms |
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 50.0% | 40.0% | 6/6 | — | 0 | 66.7% | 50.0% | 4.11 ms |
| palette-rainbow-batch-001 | Rainbow-like colors | ok | 66.7% | 60.0% | 6/6 | — | 0 | n/a | 0.0% | 2.91 ms |
| perceived-red-pagoda-001 | red | ok | 100.0% | 100.0% | 1/1 | — | 0 | n/a | 0.0% | 4.01 ms |
...
## Favorite256: native numeric sort: categories
...
## Favorite256: native numeric sort: cases

| Case | Query | Status / reason | Large-window agreement | Without uncertain pairs | Assessed / total pairs | Missing judged images | Eligibility violations | Timed first-sample agreement | Timed pair coverage | p95 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| composition-001 | 80% grayscale 20% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/1 | composition-001/A, composition-001/B | 0 | n/a | 0.0% | n/a |
| composition-002 | 80% grayscale 10% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/0 | composition-002/A, composition-002/B | 0 | n/a | n/a | n/a |
| perceived-red-001 | red | ok | 86.7% | 86.7% | 15/15 | — | 0 | n/a | 0.0% | 2.74 ms |
| vibe-grayscale-001 | grayscale | ok | 100.0% | 100.0% | 12/12 | — | 0 | n/a | 0.0% | 3.75 ms |
| vibe-dark-001 | dark | ok | 100.0% | 100.0% | 15/15 | — | 0 | n/a | 0.0% | 3.64 ms |
| combination-gray-red-001 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/15 | wallpaper-042, wallpaper-060, wallpaper-037, wallpaper-065, wallpaper-029, wallpaper-048 | 0 | n/a | 0.0% | n/a |
| combination-gray-red-002 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/3 | evaluation-gray-red-002-telephone, wallpaper-048, evaluation-gray-red-002-umbrella | 0 | n/a | 0.0% | n/a |
| precision-shade-001 | Color picker: #FF2200 | ok | 20.0% | 20.0% | 5/5 | — | 0 | 20.0% | 100.0% | 2.99 ms |
| semantic-red-city-001 | A city wallpaper with a red feel (Condition: Assuming C matches the city tag.) | ok | 100.0% | 100.0% | 3/3 | — | 0 | 100.0% | 100.0% | 1.57 ms |
| proportion-green-001 | 40% green; the rest doesn’t matter | ok | 86.7% | 86.7% | 15/15 | — | 0 | 100.0% | 20.0% | 3.21 ms |
| proportion-green-002 | 40% green; the rest doesn’t matter | ok | 93.3% | 93.3% | 15/15 | — | 0 | 93.3% | 100.0% | 5.45 ms |
| composition-green-red-001 | 50% green, 50% red | ok | 53.3% | 53.3% | 15/15 | — | 0 | 53.3% | 100.0% | 3.28 ms |
| composition-green-red-real-001 | 50% green, 50% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | 100.0% | 16.7% | 2.74 ms |
| composition-green-red-real-002 | 40% green, 40% red; the remaining 20% is unspecified | ok | 0.0% | 0.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.19 ms |
| perceived-red-batch-001 | Red | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.71 ms |
| perceived-orange-batch-001 | Orange | ok | 83.3% | 83.3% | 6/6 | — | 0 | 100.0% | 16.7% | 2.91 ms |
| perceived-pink-batch-001 | Pink | ok | 33.3% | 33.3% | 6/6 | — | 0 | n/a | 0.0% | 2.68 ms |
| perceived-green-batch-001 | Green | ok | 83.3% | 80.0% | 6/6 | — | 0 | 0.0% | 16.7% | 2.57 ms |
| perceived-blue-batch-001 | Blue | ok | 83.3% | 80.0% | 6/6 | — | 0 | n/a | 0.0% | 2.62 ms |
| proportion-green-real-batch-001 | 40% green; the remaining 60% is unspecified | ok | 16.7% | 20.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.39 ms |
| proportion-green-real-batch-002 | 70% green; the remaining 30% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | 0.0% | 16.7% | 2.83 ms |
| proportion-red-real-batch-001 | 20% red; the remaining 80% is unspecified | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.89 ms |
| vibe-dark-batch-001 | Dark | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 2.83 ms |
| vibe-light-batch-001 | Light | ok | 83.3% | 83.3% | 6/6 | — | 0 | 0.0% | 16.7% | 3.29 ms |
| vibe-vivid-batch-001 | Bright, vivid colors | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 2.72 ms |
| vibe-strict-grayscale-batch-001 | Grayscale | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 2.72 ms |
| vibe-near-neutral-batch-001 | Almost grayscale | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 2.61 ms |
| vibe-monochromatic-batch-001 | One hue overall | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.04 ms |
| combination-gray-red-batch-001 | Grayscale with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-095, wallpaper-060, evaluation-gray-red-002-telephone, wallpaper-063 | 0 | n/a | 0.0% | n/a |
| composition-gray-red-batch-001 | 80% grayscale, 20% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.61 ms |
| composition-gray-red-batch-002 | 80% grayscale, 10% red; the remaining 10% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 4.07 ms |
| vibe-dark-accents-batch-001 | Mostly dark, with small bright areas | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-005, wallpaper-032, wallpaper-022, wallpaper-015 | 0 | n/a | 0.0% | n/a |
| composition-blue-orange-batch-001 | 50% blue, 50% orange | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.23 ms |
| composition-blue-orange-batch-002 | 40% blue, 40% orange; the remaining 20% is unspecified | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.30 ms |
| precision-warm-red-batch-001 | Close to #FF2200 | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 5.00 ms |
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 50.0% | 40.0% | 6/6 | — | 0 | 66.7% | 50.0% | 2.87 ms |
| palette-rainbow-batch-001 | Rainbow-like colors | ok | 66.7% | 60.0% | 6/6 | — | 0 | n/a | 0.0% | 3.60 ms |
| perceived-red-pagoda-001 | red | ok | 100.0% | 100.0% | 1/1 | — | 0 | n/a | 0.0% | 2.94 ms |

## Favorite256: native numeric sort: visual comparisons
...
## Favorite256: native numeric sort: configuration and diagnostics
...
## Favorite256: native numeric sort with score tracking: categories
...
## Favorite256: native numeric sort with score tracking: cases

| Case | Query | Status / reason | Large-window agreement | Without uncertain pairs | Assessed / total pairs | Missing judged images | Eligibility violations | Timed first-sample agreement | Timed pair coverage | p95 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| composition-001 | 80% grayscale 20% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/1 | composition-001/A, composition-001/B | 0 | n/a | 0.0% | n/a |
| composition-002 | 80% grayscale 10% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/0 | composition-002/A, composition-002/B | 0 | n/a | n/a | n/a |
| perceived-red-001 | red | ok | 86.7% | 86.7% | 15/15 | — | 0 | n/a | 0.0% | 2.85 ms |
| vibe-grayscale-001 | grayscale | ok | 100.0% | 100.0% | 12/12 | — | 0 | n/a | 0.0% | 3.21 ms |
| vibe-dark-001 | dark | ok | 100.0% | 100.0% | 15/15 | — | 0 | n/a | 0.0% | 3.39 ms |
| combination-gray-red-001 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/15 | wallpaper-042, wallpaper-060, wallpaper-037, wallpaper-065, wallpaper-029, wallpaper-048 | 0 | n/a | 0.0% | n/a |
| combination-gray-red-002 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/3 | evaluation-gray-red-002-telephone, wallpaper-048, evaluation-gray-red-002-umbrella | 0 | n/a | 0.0% | n/a |
| precision-shade-001 | Color picker: #FF2200 | ok | 20.0% | 20.0% | 5/5 | — | 0 | 20.0% | 100.0% | 3.02 ms |
| semantic-red-city-001 | A city wallpaper with a red feel (Condition: Assuming C matches the city tag.) | ok | 100.0% | 100.0% | 3/3 | — | 0 | 100.0% | 100.0% | 1.58 ms |
| proportion-green-001 | 40% green; the rest doesn’t matter | ok | 86.7% | 86.7% | 15/15 | — | 0 | 100.0% | 20.0% | 3.06 ms |
| proportion-green-002 | 40% green; the rest doesn’t matter | ok | 93.3% | 93.3% | 15/15 | — | 0 | 93.3% | 100.0% | 4.04 ms |
| composition-green-red-001 | 50% green, 50% red | ok | 53.3% | 53.3% | 15/15 | — | 0 | 53.3% | 100.0% | 3.68 ms |
| composition-green-red-real-001 | 50% green, 50% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | 100.0% | 16.7% | 3.43 ms |
| composition-green-red-real-002 | 40% green, 40% red; the remaining 20% is unspecified | ok | 0.0% | 0.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.15 ms |
| perceived-red-batch-001 | Red | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 5.20 ms |
| perceived-orange-batch-001 | Orange | ok | 83.3% | 83.3% | 6/6 | — | 0 | 100.0% | 16.7% | 3.16 ms |
| perceived-pink-batch-001 | Pink | ok | 33.3% | 33.3% | 6/6 | — | 0 | n/a | 0.0% | 3.78 ms |
| perceived-green-batch-001 | Green | ok | 83.3% | 80.0% | 6/6 | — | 0 | 0.0% | 16.7% | 2.93 ms |
| perceived-blue-batch-001 | Blue | ok | 83.3% | 80.0% | 6/6 | — | 0 | n/a | 0.0% | 3.58 ms |
| proportion-green-real-batch-001 | 40% green; the remaining 60% is unspecified | ok | 16.7% | 20.0% | 6/6 | — | 0 | 0.0% | 16.7% | 3.05 ms |
| proportion-green-real-batch-002 | 70% green; the remaining 30% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | 0.0% | 16.7% | 3.12 ms |
| proportion-red-real-batch-001 | 20% red; the remaining 80% is unspecified | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.48 ms |
| vibe-dark-batch-001 | Dark | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.48 ms |
| vibe-light-batch-001 | Light | ok | 83.3% | 83.3% | 6/6 | — | 0 | 0.0% | 16.7% | 3.55 ms |
| vibe-vivid-batch-001 | Bright, vivid colors | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.21 ms |
| vibe-strict-grayscale-batch-001 | Grayscale | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 2.99 ms |
| vibe-near-neutral-batch-001 | Almost grayscale | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 4.02 ms |
| vibe-monochromatic-batch-001 | One hue overall | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 2.96 ms |
| combination-gray-red-batch-001 | Grayscale with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-095, wallpaper-060, evaluation-gray-red-002-telephone, wallpaper-063 | 0 | n/a | 0.0% | n/a |
| composition-gray-red-batch-001 | 80% grayscale, 20% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.08 ms |
| composition-gray-red-batch-002 | 80% grayscale, 10% red; the remaining 10% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.60 ms |
| vibe-dark-accents-batch-001 | Mostly dark, with small bright areas | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-005, wallpaper-032, wallpaper-022, wallpaper-015 | 0 | n/a | 0.0% | n/a |
| composition-blue-orange-batch-001 | 50% blue, 50% orange | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 3.26 ms |
| composition-blue-orange-batch-002 | 40% blue, 40% orange; the remaining 20% is unspecified | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.54 ms |
| precision-warm-red-batch-001 | Close to #FF2200 | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.34 ms |
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 50.0% | 40.0% | 6/6 | — | 0 | 66.7% | 50.0% | 2.70 ms |
| palette-rainbow-batch-001 | Rainbow-like colors | ok | 66.7% | 60.0% | 6/6 | — | 0 | n/a | 0.0% | 2.61 ms |
| perceived-red-pagoda-001 | red | ok | 100.0% | 100.0% | 1/1 | — | 0 | n/a | 0.0% | 3.94 ms |

## Favorite256: native numeric sort with score tracking: visual comparisons
...
## Favorite256: native numeric sort with score tracking: configuration and diagnostics
...
| composition-001 | 80% grayscale 20% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/1 | composition-001/A, composition-001/B | 0 | n/a | 0.0% | n/a |
| composition-002 | 80% grayscale 10% red | unsupported: Conceptual compositions have no image source; image-backed candidates must report this case unsupported. | n/a | n/a | 0/0 | composition-002/A, composition-002/B | 0 | n/a | n/a | n/a |
| perceived-red-001 | red | ok | 86.7% | 86.7% | 15/15 | — | 0 | n/a | 0.0% | 3.30 ms |
| vibe-grayscale-001 | grayscale | ok | 100.0% | 100.0% | 12/12 | — | 0 | n/a | 0.0% | 3.84 ms |
| vibe-dark-001 | dark | ok | 100.0% | 100.0% | 15/15 | — | 0 | n/a | 0.0% | 4.76 ms |
| combination-gray-red-001 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/15 | wallpaper-042, wallpaper-060, wallpaper-037, wallpaper-065, wallpaper-029, wallpaper-048 | 0 | n/a | 0.0% | n/a |
| combination-gray-red-002 | mostly grayscale, with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/3 | evaluation-gray-red-002-telephone, wallpaper-048, evaluation-gray-red-002-umbrella | 0 | n/a | 0.0% | n/a |
| precision-shade-001 | Color picker: #FF2200 | ok | 20.0% | 20.0% | 5/5 | — | 0 | 20.0% | 100.0% | 3.35 ms |
| semantic-red-city-001 | A city wallpaper with a red feel (Condition: Assuming C matches the city tag.) | ok | 100.0% | 100.0% | 3/3 | — | 0 | 100.0% | 100.0% | 3.00 ms |
| proportion-green-001 | 40% green; the rest doesn’t matter | ok | 86.7% | 86.7% | 15/15 | — | 0 | 100.0% | 20.0% | 6.17 ms |
| proportion-green-002 | 40% green; the rest doesn’t matter | ok | 93.3% | 93.3% | 15/15 | — | 0 | 93.3% | 100.0% | 5.03 ms |
| composition-green-red-001 | 50% green, 50% red | ok | 53.3% | 53.3% | 15/15 | — | 0 | 53.3% | 100.0% | 4.91 ms |
| composition-green-red-real-001 | 50% green, 50% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | 100.0% | 16.7% | 4.31 ms |
| composition-green-red-real-002 | 40% green, 40% red; the remaining 20% is unspecified | ok | 0.0% | 0.0% | 6/6 | — | 0 | 0.0% | 16.7% | 6.51 ms |
| perceived-red-batch-001 | Red | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 4.75 ms |
| perceived-orange-batch-001 | Orange | ok | 83.3% | 83.3% | 6/6 | — | 0 | 100.0% | 16.7% | 4.98 ms |
| perceived-pink-batch-001 | Pink | ok | 33.3% | 33.3% | 6/6 | — | 0 | n/a | 0.0% | 4.14 ms |
| perceived-green-batch-001 | Green | ok | 83.3% | 80.0% | 6/6 | — | 0 | 0.0% | 16.7% | 4.35 ms |
| perceived-blue-batch-001 | Blue | ok | 83.3% | 80.0% | 6/6 | — | 0 | n/a | 0.0% | 5.45 ms |
| proportion-green-real-batch-001 | 40% green; the remaining 60% is unspecified | ok | 16.7% | 20.0% | 6/6 | — | 0 | 0.0% | 16.7% | 4.23 ms |
| proportion-green-real-batch-002 | 70% green; the remaining 30% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | 0.0% | 16.7% | 5.24 ms |
| proportion-red-real-batch-001 | 20% red; the remaining 80% is unspecified | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 4.39 ms |
| vibe-dark-batch-001 | Dark | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 3.49 ms |
| vibe-light-batch-001 | Light | ok | 83.3% | 83.3% | 6/6 | — | 0 | 0.0% | 16.7% | 5.42 ms |
| vibe-vivid-batch-001 | Bright, vivid colors | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.69 ms |
| vibe-strict-grayscale-batch-001 | Grayscale | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 4.10 ms |
| vibe-near-neutral-batch-001 | Almost grayscale | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 3.66 ms |
| vibe-monochromatic-batch-001 | One hue overall | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.38 ms |
| combination-gray-red-batch-001 | Grayscale with red accents | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-095, wallpaper-060, evaluation-gray-red-002-telephone, wallpaper-063 | 0 | n/a | 0.0% | n/a |
| composition-gray-red-batch-001 | 80% grayscale, 20% red | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 4.19 ms |
| composition-gray-red-batch-002 | 80% grayscale, 10% red; the remaining 10% is unspecified | ok | 66.7% | 66.7% | 6/6 | — | 0 | n/a | 0.0% | 4.83 ms |
| vibe-dark-accents-batch-001 | Mostly dark, with small bright areas | unsupported: This prototype has no accent or relative-contrast objective. Use explicit proportions for these combinations. | n/a | n/a | 0/6 | wallpaper-005, wallpaper-032, wallpaper-022, wallpaper-015 | 0 | n/a | 0.0% | n/a |
| composition-blue-orange-batch-001 | 50% blue, 50% orange | ok | 50.0% | 50.0% | 6/6 | — | 0 | n/a | 0.0% | 5.54 ms |
| composition-blue-orange-batch-002 | 40% blue, 40% orange; the remaining 20% is unspecified | ok | 83.3% | 83.3% | 6/6 | — | 0 | n/a | 0.0% | 5.49 ms |
| precision-warm-red-batch-001 | Close to #FF2200 | ok | 100.0% | 100.0% | 6/6 | — | 0 | n/a | 0.0% | 3.93 ms |
| precision-muted-green-batch-001 | Close to #4C8C72 | ok | 50.0% | 40.0% | 6/6 | — | 0 | 66.7% | 50.0% | 3.52 ms |
| palette-rainbow-batch-001 | Rainbow-like colors | ok | 66.7% | 60.0% | 6/6 | — | 0 | n/a | 0.0% | 3.49 ms |
| perceived-red-pagoda-001 | red | ok | 100.0% | 100.0% | 1/1 | — | 0 | n/a | 0.0% | 5.19 ms |
