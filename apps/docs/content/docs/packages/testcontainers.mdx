...
S3 test storage is provided by `S3TesterBuilder` in [`@wallpaperdb/test-utils`](/docs/packages/test-utils#s3testerbuilder). It starts SeaweedFS and exposes bucket management and an AWS SDK S3 client.
