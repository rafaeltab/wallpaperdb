...
This guide documents existing test command groups, infrastructure setup, and debugging workflows. [CODING_STANDARDS.md — Testing](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#testing) defines the required test boundaries and coverage. The command groups below describe current tooling; their names do not determine which boundary owns a behavior.
