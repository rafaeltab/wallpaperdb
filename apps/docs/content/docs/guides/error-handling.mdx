...
The existing helpers were written against [RFC 7807](https://tools.ietf.org/html/rfc7807). Current requirements are in [Coding Standards — Public HTTP APIs](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#public-http-apis).
...
The placeholder URLs in the existing examples predate the accepted problem-type URI scheme. Use [Coding Standards — Public HTTP APIs](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md#public-http-apis) for the required URLs.
