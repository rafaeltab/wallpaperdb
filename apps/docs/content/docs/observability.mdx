...
**See also:** [Infrastructure: Grafana](/docs/infrastructure/grafana) - Complete Grafana LGTM stack documentation
...
| `reconciliation.errors.total` | Counter | `reconciliation.type` | Isolated upload/asset failures and failed reconciliation cycles; shutdown interruptions are excluded |
...
- [Infrastructure: Grafana](/docs/infrastructure/grafana) - Complete LGTM stack setup and usage
- [Package: Core](/docs/packages/core) - Telemetry helpers and OtelConnection
- [Guide: Creating New Service](/docs/guides/creating-new-service) - Integrating OpenTelemetry in new services
