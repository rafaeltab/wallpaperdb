...
def audit_fidelity():
 ...
 with (D/'audit-independent-v2.json').open('x') as out: json.dump(report,out,indent=2);out.write('\n')
...
def audit_feedback():
 ...
 with (ROOT/'pooled-feedback-execution-path-audit-v2.json').open('x') as out: json.dump(report,out,indent=2);out.write('\n')
