...
Use the issue tracker and triage conventions in [AGENTS.md](../../../AGENTS.md#issue-tracker).
...
1. Issue references in the commit messages, such as `#123` or `Closes #45`. Fetch the full body, comments, and labels with `gh`.
