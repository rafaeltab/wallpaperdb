...
Reusable Testcontainers setups for integration testing. Provides custom NATS container configuration. S3 storage setup runs SeaweedFS through `S3TesterBuilder` in `@wallpaperdb/test-utils`.
