...
export const WallpaperVariantAvailableEventSchema = z.object({
  ...
  variant: z.object({
    ...
    // Format information
    format: z.enum(["jpeg", "png", "webp"]), // For filtering/querying
...
export type WallpaperVariantAvailableEvent = z.infer<typeof WallpaperVariantAvailableEventSchema>;

export const WALLPAPER_VARIANT_AVAILABLE_SUBJECT = "wallpaper.variant.available" as const;
