.PHONY: infra-start infra-stop infra-reset infra-logs apps-start apps-stop \
        ...
        dev build test test-watch test-unit test-integration test-e2e test-ui storage-test storage-infra-test coverage-summary format lint check-types ci ci-force clean help
