...
This page covers the development and contribution workflow for WallpaperDB. The authoritative coding guidelines are indexed in [CODING_STANDARDS.md](https://github.com/rafaeltab/wallpaperdb/blob/main/CODING_STANDARDS.md).
