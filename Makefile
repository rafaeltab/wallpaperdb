.PHONY: infra-start infra-stop infra-reset infra-logs apps-start apps-stop \
        ...
        dev build test test-watch test-unit test-integration test-e2e test-ui storage-test storage-infra-test coverage-summary crap check-crap format lint check-types ci ci-force clean help
...
crap:
	@node scripts/crap.mjs report

check-crap:
	@node scripts/crap.mjs check
