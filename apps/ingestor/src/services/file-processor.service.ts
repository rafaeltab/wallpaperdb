...
export class FileProcessorService {
   ...
   */
  private validateFileFormat(mimeType: string, limits: ValidationLimits): void {
   ...
   */
  private validateDimensions(width: number, height: number, limits: ValidationLimits): void {
    if (
