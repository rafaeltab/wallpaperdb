...
export function loadConfig(): Config {
  ...
  const raw = {
    ...
    profileEvidenceRetentionDays: parseIntEnv(process.env.PROFILE_EVIDENCE_RETENTION_DAYS, 30),
